...
<div className="  flex flex-col  mt-2 items-center md:flex-row px-12 py-5 text-center pt-5">
        <div className="w-[40%]">
          ...
          <div className=" flex space-x-2 mt-12">
            <button className=" text-[14px] bg-[#19013A] p-2 text-white rounded-md flex items-center space-x-2 ">
            ...
            <button className=" tex-[14px] bg-white p-2 rounded-md flex items-center space-x-2 ">
            <Image 
