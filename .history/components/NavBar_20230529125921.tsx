...
function NavBar() {
  return (
    <div className=" flex items-center flex-col md:flex-row p-10 text-center pt-5">
    <div>
    <Image 
    ...
    <li className=' text-white list-none'>NFT</li>
          ...
          <button className=" px-72 rounded-md py-3    text-xs bg-[#7049f7] text-white text-center  ">Get wallet</button>
    </div>
