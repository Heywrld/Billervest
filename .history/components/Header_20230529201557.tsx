...
function Header() {
  return (
    <header className=' bg-[#230251]'>
        <NavBar />
        <hr 
       className=' w-[96.8%] border-1 border-gray-500 bg-rgba(255, 255, 255, 0.15); '
       />  
...
<div className="  flex flex-col  mt-2 items-center md:flex-row px-12 py-5 text-center pt-5">
        <div className="w-[40%]">
          ...
          <ul className=' justify-start space-y-2 mb-3  text-[#00FBFF] text-[20px]'>
            <li className=' flex space-x-1'>
            <Image 
            ...
            height={10}
            />
            <span> Buy, exchange and stake crypto in a secured mobile and desktop app</span>
