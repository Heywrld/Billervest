...
<div className="  flex flex-col  mt-2 items-center md:flex-row px-12 py-5 text-center pt-5">
        <div className="w-[40%]">
          <h1 className=" flex text-[50px] text-white leading-[66px] mb-3">BillerVest Wallet</h1>
          <p className=' text-white mb-3 flex text-[26px]'>Your best option to access the world of crypto</p>
          
          <ul className=' mb-3  text-[#00FBFF] text-[20px]'>
            <li className=' flex space-x-1'>
            <Image 
            ...
            height={10}
            />
            <span> Buy, exchange and stake crypto in a secured mobile 
and desktop app</span>
            </li>
            <li className=' flex space-x-1'>
            <Image 
            src="/assets/Ellipse.svg"
