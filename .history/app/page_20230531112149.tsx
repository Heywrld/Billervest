      ...
      <div className="  flex items-center  md:flex-row px-12 pb-3 text-center ">
        ...
        <div className="w-[40%] items-center space-y-10  ">
         ...
         />
          ...
          <div className="  flex items-center mt-12  md:flex-row px-12 pb-5 text-center ">
          <div className=' w-1/2 px-10 animate-pulse '>
          <Image 
        ...
        <div className=" w-1/2">
          <h1 className=" flex text-[40px] text-white font-[600px]  mb-10 mr-20">40+ coins and any tokens on 7 networks</h1>
          ...
          <div className=" flex space-x-5 mt-16">
            <button className="  bg-[#7049F7] text-[14px] px-16 py-4 rounded-[5px] text-white  flex items-center space-x-2 ">Get Wallet</button>
            <button className="  bg-[#1A1A1A] tex-[14px] text-white px-16 py-4 rounded-[5px] flex items-center space-x-2 ">Show All Wallets</button>
          </div>
        </div> 
          </div>
        ...
        <div className="w-[40%] items-center space-y-10  ">
          <h1 className=" flex text-[35px] text-white font-[600px]  mt-[150px]">Explore our decentralised finance platform with confidence </h1>
          <ul className='  text-[#00FBFF] space-y-2 list-disc text-sm'>
            <li>Instant crypto-to-crypto and fiat-to-crypto exchanges.</li>
            <li>Advanced settings including account nonce for ETH transaction.</li>
            <li>Our support team at your service.</li>
          </ul>
          <div className=" flex space-x-5 ">
            <button className="  bg-[#7049F7] text-[14px] px-16 py-4 rounded-[5px] text-white  flex items-center space-x-2 ">Get Wallet</button>
            <button className="  bg-[#1A1A1A] tex-[14px] text-white px-16 py-4 rounded-[5px] flex items-center space-x-2 ">Try on this site</button>
         ...
         <div className="  flex items-center mt-12    md:flex-row  pb-5 text-center ">
          <div className=' px-10 animate-pulse '>
          <Image 
         src="/assets/wider.png"
         alt=""
         width={200}
         height={300}
         className=" w-[630px] h-[400px]    "
         />
          </div>
        
        <div className=" w-1/2">
          <h1 className=" flex text-[40px] text-white font-[600px]  mb-10 mr-20">Wider and even more
secured 👩‍💻</h1>
          <p className=' text-[#00FBFF]  flex text-sm'>Full-featured multicurrency wallet on your laptop. Much more useful working space and no room for mistakes. Full and secured sync with a mobile app.
</p>  
        
          <div className=" flex space-x-5 mt-16">
            <button className="  bg-[#7049F7] text-[14px] px-16 py-4 rounded-[5px] text-white  flex items-center space-x-2 ">Download Wallet</button>
