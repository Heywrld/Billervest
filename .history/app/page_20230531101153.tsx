...
/>
      ...
      <div className="  flex items-center  md:flex-row px-12 pb-3 text-center ">
        ...
        <div className="w-[40%] items-center space-y-10  ">
          ...
          <p className=' text-[#00FBFF]  flex text-'>Biller Vest Wallet is your passport to the decentralised finance web. Harness the power of DeFi to earn yield, grow your NFT collection, and much more.</p>
