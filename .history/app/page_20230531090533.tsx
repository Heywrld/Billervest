...
/>
      ...
      <div className="  flex items-center mt-2 md:flex-row px-12 py-5 text-center pt-5">
        ...
        <div className=" w-1/2">
          <h1 className=" flex text-[52px] text-white font-[600px]  mb-10 mr-12">Buy  and sell crypto with credit card & bank account</h1>
         
          <ul className=' space-y-2 mb-3  text-[#00FBFF] text-sm'>
          ...
          <div className=" flex space-x-2 mt-16">
            <button className="  bg-[#7049F7] text-[14px] px-8 py-4 rounded-[5px] text-white  flex items-center space-x-2 ">Get Wallet</button>
