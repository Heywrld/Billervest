...
/>
      ...
      <div className="  flex justify-evenly mt-2 items-center md:flex-row px-12 py-5 text-center pt-5">
          <div className='  mr-[300px]   animate-pulse'>
          <Image 
         src="/assets/buyandsellphone.png"
         alt=""
         width={200}
         height={300}
         className=" w-[270px] h-[539px] mb-[200px]   "
         />
          </div>
        
        <div className=" p-10 items ">
          <h1 className=" flex text-[50px] text-white leading-[66px] mb-7">Buy  and sell crypto with credit card & bank account</h1>
