      ...
      <div className="  flex items-center mt-2 md:flex-row px-12 py-5 text-center pt-5">
        ...
        <div className=" w-1/2">
          ...
          <div className=" flex space-x-2 mt-16">
            <button className="  bg-[#7049F7] px-8 py-4 rounded-[5px] text-white  flex items-center space-x-2 ">
              

              <span className=" text-[14px]">Get Wallet</span></button>
            <button className="  bg-[#1A1A1A] tex-[14px] text-white px-8 py-4 rounded-[5px] flex items-center space-x-2 ">
            
              <span className=''>Try BillerVest</span></button>
          </div>
        </div> 
          </div>
    </main>
