      ...
      <div className="  flex items-center mt-2 md:flex-row px-12 py-5 text-center pt-5">
        ...
        <div className=" w-1/2">
          ...
          <div className=" flex space-x-2 mt-16">
            <button className="  bg-[#7049F7] px-4 py-2 text-white rounded-sm flex items-center space-x-2 ">
              

              <span className=" text-[14px]">Get Wallet</span></button>
            <button className="  bg-[#1A1A1A] px-4 py-2 rounded-sm flex items-center space-x-2 ">
            
              <span className='tex-[14px] p- text-white'>Try BillerVest</span></button>
          </div>
        </div> 
          </div>
    </main>
