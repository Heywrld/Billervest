...
/>
      ...
      <div className="  flex items-center  md:flex-row px-12 pb- text-center ">
        ...
        <div className="w-[40%]">
          <h1 className=" flex text-[52px] text-white font-[600px]  mb-10">Explore our decentralised finance platform with confidence </h1>
          <p className=' text-white mb-4 flex text-[26px]'>Biller Vest Wallet is your passport to the decentralised finance web. Harness the power of DeFi to earn yield, grow your NFT collection, and much more.</p>
