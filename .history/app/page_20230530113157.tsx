  ...
  return (
    <main className=' bg-[#230251]' >
      ...
      <div className=' bg-[#19013A] mt-10' >
        ...
        <div className=' w-[1380px] mx-auto rounded-lg m-8 space-x-1  flex justify-evenly p-10 bg-[#5237B1] '>
...
<div className=' p-5 items-center items-center  '>
  <h1 className=' break-words  text-white text-[40px] leading-[47px]'>Manage your money with exceptional
privacy & security</h1>
  <p className=' w-[750px] h-[65px] break-words text-[#D4D4D4] text-[20px] leading-[23px]'>The BillerVest Wallet is non-custodial: we are not in possession of any personal data. 
