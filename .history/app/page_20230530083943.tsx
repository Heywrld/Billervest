  ...
  return (
    <main className=' bg-[#230251]' >
      ...
      <div className=' bg-[#19013A] mt-10' >
        ...
        <div className=' w-[1380px] mx-auto rounded-lg m-8 space-x-1  flex justify-between p-10 bg-[#5237B1] '>
          <Image
          ...
          height={200}
          />
          <div className=' p-4 just'>
            <h1 className=' text-white text-[40px]'>Manage your money with exceptional
privacy & security</h1>
            <p className=' text-[#D4D4D4] text-[20px]'>The BillerVest Wallet is non-custodial: we are not in possession of any personal data. 
