...
/>
      ...
      <div className="  flex items-center  md:flex-row px-12 pb-3 text-center ">
        ...
        <div className="w-[40%] items-center space-y-4  ">
          <h1 className=" flex text-[40px] text-white font-[600px]  mt-[150px]">Explore our decentralised finance platform with confidence </h1>
          <p className=' text-[#00FBFF]  flex text-[18px]'>Biller Vest Wallet is your passport to the decentralised finance web. Harness the power of DeFi to earn yield, grow your NFT collection, and much more.</p>
          ...
          <div className='flex  flex-1 w-full justify-end animate-pulse mt-6'>
          <Image 
