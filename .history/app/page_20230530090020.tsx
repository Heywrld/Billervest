...
privacy & security</h1>
  <p className=' w-[750px] h-[65px] brw text-[#D4D4D4] text-[20px] leading-[23px]'>The BillerVest Wallet is non-custodial: we are not in possession of any personal data. 
