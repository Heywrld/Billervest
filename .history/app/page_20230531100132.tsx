...
/>
      ...
      <div className="  flex items-center  md:flex-row px-12 pb-3 text-center ">
        ...
        <div className=" w-1/2">
          ...
          <div className=" mt-2 bg-[#19013A] ">
              
          <div className=" flex justify-evenly w-[1300px] mx-auto mt-2 ">
        <div className="w-[40%]">
          <h1 className=" flex text-[40px] text-white font-[600px]  mb-10">Explore our decentralised finance platform with confidence </h1>
          <p className=' text-[#00FBFF] mb-4 flex text-[18px]'>Biller Vest Wallet is your passport to the decentralised finance web. Harness the power of DeFi to earn yield, grow your NFT collection, and much more.</p>
        
          <div className=" flex space-x-5 mt-16">
            <button className="  bg-[#7049F7] text-[14px] px-16 py-4 rounded-[5px] text-white  flex items-center space-x-2 ">Get Wallet</button>
            <button className="  bg-[#1A1A1A] tex-[14px] text-white px-16 py-4 rounded-[5px] flex items-center space-x-2 ">Try on </button>
          </div>
        </div> 
          <div className='flex  flex-1 w-full justify-end animate-pulse'>
          <Image 
